  ...
  return (
    <Container>
        ...
        <Grid columns={5} stackable centered>
          <Grid.Row>
            <Grid.Column textAlign="center">
              ...
              <Header as="h4" style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800}}>Sydney Aurelius</Header>
              <p style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400}}>Project Manager</p>
            </Grid.Column>
            <Grid.Column textAlign="center">
              <Image centered circular size="small" src={alexa} alt="Alexa Gonzalez" />
              <Header as="h4" style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800}}>Alexa Gonzalez</Header>
              <p style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400}}>Frontend Developer</p>
            </Grid.Column>
            <Grid.Column textAlign="center">
              <Image centered circular size="small" src={julia} alt="Julia Chancey" />
              <Header as="h4" style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800}}>Julia Chancey</Header>
              <p style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400}}>Backend Developer</p>
            </Grid.Column>
            <Grid.Column textAlign="center">
              <Image centered circular size="small" src={julian} alt="Julian Ubico" />
              <Header as="h4" style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800}}>Julian Ubico</Header>
              <p style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400}}>Backend Developer</p>
            </Grid.Column>
            <Grid.Column textAlign="center">
              <Image centered circular size="small" src={camryn} alt="Camryn Cimber" />
              <Header as="h4" style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800}}>Camryn Cimber</Header>
              <p style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400}}>Frontend Developer</p>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      ...
      <Segment padded="very" vertical>
        ...
        <p style={{ textAlign: "left", fontSize: "1.2em", fontFamily: '"Abhaya Libre", serif', fontWeight: 400 }}>
        ...
        <Card.Group centered itemsPerRow={3}>
          <Card>
            ...
            <Card.Content textAlign="center">
              <Card.Header style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800, fontSize: "20px" }}>Inclusivity & Accessibility</Card.Header>
              <Card.Description style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400, fontSize: "15px" }}>
          ...
          <Card>
            ...
            <Card.Content textAlign="center">
              <Card.Header style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800, fontSize: "20px" }}>Community & Connection</Card.Header>
              <Card.Description style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400, fontSize: "15px" }}>
          ...
          <Card>
            ...
            <Card.Content textAlign="center">
              <Card.Header style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 800, fontSize: "20px" }}>Sustainability & Impact</Card.Header>
              <Card.Description style={{ fontFamily: '"Abhaya Libre", serif', fontWeight: 400, fontSize: "15px" }}>
